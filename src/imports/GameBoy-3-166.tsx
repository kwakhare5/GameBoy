import svgPaths from "./svg-4y7r55y6fl";

function DPad1() {
  return (
    <div className="absolute left-[20px] size-[72px] top-[212px]" data-name="D-Pad">
...
function DPad() {
  return (
    <div className="absolute contents left-[20px] top-[212px]" data-name="D-Pad">
      <DPad1 />
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] h-[32.727px] items-center right-[66.8px] top-[231.64px] w-[25.2px]" data-name="Button">
      <Button2 />
...
function Button3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] h-[32.727px] items-center right-[43.4px] top-[208px] w-[25.2px]" data-name="Button">
      <Button4 />
      <div className="flex flex-col font-['IBM_Plex_Mono:Bold',sans-serif] justify-end leading-[0] not-italic relative shrink-0 text-[#302f6b] text-[8px] tracking-[-0.24px] whitespace-nowrap">
...
function Button5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] h-[32.727px] items-center right-[20px] top-[231.64px] w-[25.2px]" data-name="Button">
      <Button6 />
      <div className="flex flex-col font-['IBM_Plex_Mono:Bold',sans-serif] justify-end leading-[0] not-italic relative shrink-0 text-[#302f6b] text-[8px] tracking-[-0.24px] whitespace-nowrap">
...
function Button7() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] h-[32.727px] items-center right-[43.4px] top-[255.27px] w-[25.2px]" data-name="Button">
      <Button8 />
      <div className="flex flex-col font-['IBM_Plex_Mono:Bold',sans-serif] justify-end leading-[0] not-italic relative shrink-0 text-[#302f6b] text-[8px] tracking-[-0.24px] whitespace-nowrap">
...
function Button() {
  return (
    <div className="absolute contents right-[20px] top-[208px]" data-name="Button">
      <Button1 />
      <Button3 />
      <Button5 />
      <Button7 />
...
function Button9() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[2px] h-[28px] items-center left-1/2 top-[196px] w-[22px]" data-name="Button">
      <Button10 />
      <div className="flex flex-col font-['IBM_Plex_Mono:Bold',sans-serif] justify-end leading-[0] not-italic relative shrink-0 text-[#302f6b] text-[8px] tracking-[-0.24px] whitespace-nowrap">
...
function Button12() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] h-[22px] items-center relative w-[32px]" data-name="Button">
      <Button13 />
      <div className="flex flex-col font-['IBM_Plex_Mono:Bold',sans-serif] justify-end leading-[0] not-italic relative shrink-0 text-[#302f6b] text-[8px] tracking-[-0.24px] whitespace-nowrap">
...
function Group2() {
  return (
    <div className="-translate-x-1/2 absolute contents left-[calc(50%-26.91px)] top-[296px]">
      <div className="-translate-x-1/2 absolute flex items-center justify-center left-[calc(50%-26.91px)] size-[38.184px] top-[296px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "22" } as React.CSSProperties}>
...
function Group1() {
  return (
    <div className="-translate-x-1/2 absolute contents left-[calc(50%+26.09px)] top-[296px]">
      <div className="-translate-x-1/2 absolute flex items-center justify-center left-[calc(50%+26.09px)] size-[38.184px] top-[296px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "22" } as React.CSSProperties}>
        <div className="-rotate-45 flex-none">
          <Button15 />
        </div>
      </div>
...
function Frame() {
  return <div className="absolute bg-[#1b1b1b] inset-[12px] rounded-[1px]" />;
}

function ScreenContainer() {
  return (
    <div className="-translate-y-1/2 absolute aspect-[246/190] bg-[#080808] left-[6px] overflow-clip right-[6px] rounded-[6px] shadow-[0px_1px_1px_0px_rgba(255,255,255,0.5)] top-[calc(50%-80px)]" data-name="Screen container">
      <Frame />
...
export default function GameBoy() {
  return (
    <div className="bg-[#c8c5c2] overflow-clip relative rounded-bl-[14px] rounded-br-[14px] rounded-tl-[10px] rounded-tr-[10px] size-full" data-name="GameBoy">
      <DPad />
      <Button />
      <Button9 />
      <Group2 />
